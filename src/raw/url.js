...
*/
const urlRegex = /^(https?:\/\/)(\S+(?::\S*)?@)?((([1-9]\d?|1\d\d|2[01]\d|22[0-3])(\.(1?\d{1,2}|2[0-4]\d|25[0-5])){2}(\.([1-9]\d?|1\d\d|2[0-4]\d|25[0-4])))|((([a-z\u00a1-\uffff]+[0-9-_]+-?)*[a-z\u00a1-\uffff]+[0-9]*)(\.([a-z\u00a1-\uffff0-9]+-?)*[a-z\u00a1-\uffff0-9]+)*(\.([a-z\u00a1-\uffff]{2,}))*))(:\d{2,5})?(?:\/[^\s]*)?$/ui
 ...
 *   https://host-with-dashes.domain.com:30443/path
 *   https://host2-with-2dashes.domain.com:30443/path
 *   https://host_with_underscores.domain.com:30443/path
 *   https://host2_with_2underscores.domain.com:30443/path
 *
